...
OutputBaseFilename=PRRX_Internet_Download_Manager_v{#MyAppVersion}_Setup
...
Source: "D:\Internet Download Manager\publish\*cor3.dll"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
